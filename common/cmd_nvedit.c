...
DECLARE_GLOBAL_DATA_PTR;
    ...
    !defined(CFG_ENV_IS_IN_SEEPROM)	&& \
    !defined(CFG_ENV_IS_IN_FLASH)	&& \
    !defined(CFG_ENV_IS_IN_DATAFLASH)	&& \
    !defined(CFG_ENV_IS_IN_NAND)	&& \
    !defined(CFG_ENV_IS_NOWHERE)
# error Define one of CFG_ENV_IS_IN_{NVRAM|EEPROM|SEEPROM|FLASH|DATAFLASH|NOWHERE}
#endif
...
/* For Mac addr sync with Env and EEPROM : by KB Kim 2010_06_17 */
#ifdef CONFIG_DRIVER_CN100
extern int 	set_mac_addr ( u8 mac_addr[6] );
unsigned char MacAddrChanged = 0;
#endif
