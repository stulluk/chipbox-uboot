...
#if defined(CONFIG_ARCH_CSM1100) /* for orion_1.3 */
...
#elif defined(CONFIG_ARCH_CSM1200) /* for orion_1.4 */
...
int do_usbtest_md (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
