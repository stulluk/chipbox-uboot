...
void ide_init (void)
{
#ifdef CONFIG_IDE_PALM_BK3710
	{
#if 0
		/* pin mux */
		*(volatile unsigned int*)0x10171400 = 0x00000030;
		udelay(20);
		*(volatile unsigned int*)0x10260030 = 0xffff0000;
		udelay(20);
#endif

		//ide_outb(0, ATA_DATA_REG, val);
		extern int palm_bk3710_chipinit (void);
