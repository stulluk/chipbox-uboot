...
#ifdef CONFIG_HW_GPIO  	/* added by ehnus */
...
int gpio2_hw_set_direct(int gpio_id, int dir);
unsigned short gpio2_hw_read(int gpio_id);
int gpio2_hw_write(int gpio_id, unsigned short data);
#endif

#ifdef CONFIG_CELESTIAL
int uart_read(unsigned int devport, uchar *buf, ushort  len);
int uart_write(unsigned int devport, uchar *buf, ushort  len);
int uart_tstc(unsigned int devport);
#endif
